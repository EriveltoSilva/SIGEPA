...
<%@ page import="models.CategoryModel" %>
    ...
    <head>
        ...
        <title>SIGEPA - Edição de Categoria</title>
                            ...
                            <%@ include file="/partials/error-messages.jsp" %>
                                ...
                                <div class="row">
                                    <div class="d-sm-none d-md-none col-12 col-sm-12 col-md-6 d-none d-lg-block d-lg-6">
                                        <img class="w-100 h-100" src="assets/images/banner_10.jpg" alt="Um novo Acordo">
                                    </div>
                                                ...
                                                <input type="hidden" name="id" value="<%= category.getId() %>">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="name" class="form-control"
                                                            id="exampleInputNome1" placeholder="Nome da Categoria" value="<%= category.getName() %>">
                                                    </div>
